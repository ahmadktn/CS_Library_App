...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, ActivityIndicator, Alert, Platform, PermissionsAndroid, Linking } from 'react-native';
...
export default function DocumentListScreen() {
    ...
    const handleView = async (doc: DocumentInfo) => {
        ...
        try {
            ...
            // Copy to a public location first
            let sourcePath = doc.localUri;
            if (sourcePath.startsWith('file://')) {
                sourcePath = sourcePath.replace('file://', '');
            }

            // Copy to Downloads so other apps can access it
            const publicPath = `${RNFS.DownloadDirectoryPath}/${doc.name}`;
